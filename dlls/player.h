...
public:
	...
	EHANDLE m_pTank;		 // the tank which the player is currently controlling,  NULL if no 
	EHANDLE m_pRCcar;		 // the tank which the player is currently controlling,  NULL if no tank
